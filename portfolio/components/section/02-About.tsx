                ...
                <Layout>
                    <Title>
                        ...
                        <Wrap>
                            ...
                            <div className="subTitleKo" style={{color: '#2EBF91'}}>열정과 목표</div>
                        </Wrap>
                    </Title>
                    <Content>
                        <EduInfo>
                            ...
                            <div>
                                ...
                                웹 개발은 사용자에게 최상의 경험을 제공하는 작업입니다. 저는 문제 해결 능력과 창의력을 결합해<br/>
                                사용자 친화적이고 직관적인 웹 애플리케이션을 만드는 것을 목표로 합니다.<br/>
                                이를 위해 코드의 품질을 지속적으로 향상시키고, 사용자 피드백을 반영하며, 최신 기술을 학습하고 있습니다.
                            </div>
                            <div className="emphasis">끊임없이 배우고 성장하는 자세로, 사용자에게 가치 있는 경험을 제공하며 개발자로서의 열정과 목표를 실현해 나가겠습니다.</div>
                        </EduInfo>
                    </Content>
                </Layout>
            </Body>
