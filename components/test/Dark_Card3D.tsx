...
const HowContact = () => {
  ...
  return (
    <group position={[-0.1, -1.5, 0]}>
      <Text position={[-5, 1.3, 0.3]} fontSize={fontSize} letterSpacing={0.05} color="#000" anchorX="left" anchorY="middle">
        Phone
      </Text>
      <Text position={[-3.7, 1.3, 0.3]} fontSize={fontSize} letterSpacing={0.05} color="#000" anchorX="left" anchorY="middle">
        010 - 9857 - 2619
      </Text>
      <Text position={[-5, 0.4, 0.3]} fontSize={fontSize} letterSpacing={0.05} color="#000" anchorX="left" anchorY="middle">
        E-mail
      </Text>
      <Text position={[-3.7, 0.4, 0.3]} fontSize={fontSize} letterSpacing={0.05} color="#000" anchorX="left" anchorY="middle">
...
const Card = () => {
  ...
  return (
    <group ref={cardRef} position={[0, 1.2, 0]}>
      <RoundedBox args={[14, 7.5, 0.5]} radius={0.3} smoothness={4} position={[0, 0, 0]}>
      ...
      <Text position={[-5.1, 2.5, 0.3]} fontSize={0.5} letterSpacing={0.05} maxWidth={10} color="#000" anchorX="left" anchorY="middle">
        김한빈
      </Text>
      <Text position={[-5.1, 1.5, 0.3]} fontSize={0.38} letterSpacing={0.05} maxWidth={10} color="#000" anchorX="left" anchorY="middle">
        Frontend Developer
      </Text>
      <HowContact />
...
const Dark_Card3D = () => {
  ...
  return (
    <Canvas camera={{ fov: 50, position: [0, 0, 13.5]}} color={'#fff'}>
      <ambientLight intensity={5} />
      <directionalLight intensity={15.0} position={[-5, 3, 4.5]} />
      <directionalLight intensity={5.0} position={[-5, -3, 4.5]} />
      {/* <directionalLight intensity={10.0} position={[16, 13, -8.5]} /> *카드뒷면 */}
      <Card/>
      <OrbitControls
        ref={controlRef}
        enableZoom={false}
